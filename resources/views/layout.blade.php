        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav d-flex justify-content-between">
                    ...
                    @guest
                        <div class="d-flex">
                            <a class="nav-link text-white" href="/registration">Regisztráció</a>
                    ...
                    @auth
                        ...
                        <form action="/logout" method="post">
                            @csrf
                            <button type="submit"
                                class="nav-link text-white border-0 bg-transparent">Kijelentkezés</button>
                        </form>
                    @endauth
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <p>Email: <a class="link-light"
                            href="mailto:hivatal@pusztaszentmaria.hu">hivatal@pusztaszentmaria.hu</a></p>
                </div>
            </div>
        </div>
    </footer>
